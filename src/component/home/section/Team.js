                ...
                <div className="section-title">
                    <div className="row">
                        <div className="col-md-8 col-md-offset-2 text-center">
                            <h2><span className="color-defult">Experience</span> Doctor</h2>
                            ...
                            <div className="item col-md-4">
                                <div className="team-item-2">
                                    ...
                                    <div className="team-content">
                                        ...
                                        <h6>Cardiologists</h6>
                                        <div className="team-content-icon">
                                    ...
                                    <div className="timetable">
                                        <div className="item">
                                            ...
                                            <div className="value">08:00 - 17:00</div>
                                        </div>
                                        <div className="item">
                                        ...
                                        <div className="item">
                                            ...
                                            <div className="value">12:00 - 14:00</div>
                                        </div>
                                        <a href="#" className="btn-theme text-center btn-block"> View Profile</a>
                                    </div>
                                </div>
                            </div>
                            <div className="item col-md-4">
